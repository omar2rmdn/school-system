...
import { useDeleteUserMutation, getQueryErrorMessage } from "../../queries/users";
...
export default function DeleteParentModal({
  ...
  async function handleConfirm() {
    await deleteMutation.mutateAsync(parent._id);
    onClose();
  }
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-950/40 px-4">
      <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl">
        <h2 className="text-xl font-semibold text-slate-950">Delete Parent</h2>
