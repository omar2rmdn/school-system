  ...
  const handleAddParent = async () => {
    ...
    try {
      ...
      if (!response.ok) {
        ...
        console.log("ADD-PARENT server replied", response.status, txt);

        // Try to parse JSON to extract errors/title and handle duplicates
        let message = `Failed to add parent. Status: ${response.status}`;
        try {
